...
* Matrix.h
* Matrix header file for Matrix ADT
****************************************/
...
// Define a Matrix data structure as a pointer to a double pointer
typedef struct MatrixObj* Matrix;

// Return a reference to a new n x n Matrix object in the zero state
Matrix newMatrix(int n);

// Free heap memory associated with *pM, sets *pM to NULL
